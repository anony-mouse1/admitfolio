...
export async function GET(): Promise<Response> {
  ...
  const lines = [
    ...
    'for one application, sold together at a single price. A listing names the college',
    'it was written for, the prompts each essay answers, and how many essays it holds.',
    '',
