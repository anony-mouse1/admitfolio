  ...
  return (
    <main className="legal-page">
      ...
      <p>
        ...
        profiling, and we do not sell it. Watermarks remain in any copy that has already been
        issued. If you believe a record is inaccurate, or you want to ask us to delete yours,
